    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-xl border border-slate-200 p-6 md:p-8 mb-6 md:mb-8">
        ...
        <form id="filter-form" method="GET" action="{{ route('staff.dashboard') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-5">
            <div>
                ...
                <select name="year" id="year-filter" class="form-select w-full border-slate-200 bg-slate-50 rounded-xl p-3 md:p-3.5 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all text-xs md:text-sm font-medium hover:bg-white">
