      ...
      <div class="glass-card rounded-3xl p-8 md:p-10 w-full max-w-md slide-in-right">
        ...
        <div id="loginForm" class="space-y-6">
          ...
          <form method="POST" action="{{ url('staff/login') }}" class="space-y-5">
            ...
            <!-- Access Code Input -->
            <div>
              <label class="block text-sm font-bold text-slate-700 mb-2">Access Code</label>
              <div class="relative">
                ...
                <input 
                  ...
                  required 
                  autofocus
                  placeholder="Enter your registered access code" 
                  class="form-input w-full pl-12 pr-12 py-3.5 rounded-xl focus:ring-4 focus:ring-orange-500/20 outline-none"
                />
                <button 
                  type="button" 
                  onclick="togglePassword('access_code', 'codeEye', 'codeEyeSlash')" 
                  class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-slate-600 transition-colors"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" id="codeEye">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                  <svg class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" id="codeEyeSlash">
