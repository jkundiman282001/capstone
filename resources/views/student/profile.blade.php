            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="glass-card rounded-3xl p-8 text-center relative group hover:shadow-xl hover:shadow-orange-100/50 transition-all duration-500">
                    ...
                    @if($isGrantee)
                        ...
                        <a href="{{ route('student.renew') }}" class="w-full btn bg-green-600 text-white hover:bg-green-700 rounded-xl py-3.5 font-bold shadow-lg shadow-green-600/20 hover:shadow-green-600/30 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 group">
