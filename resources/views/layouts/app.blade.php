...
<body class="bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 min-h-screen font-sans">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside id="sidebar" class="no-scrollbar w-30 bg-gradient-to-b from-slate-50 to-white shadow-2xl border-r border-slate-200 hidden md:block fixed md:sticky top-0 h-screen z-40 overflow-y-auto">
