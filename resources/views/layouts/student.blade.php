                ...
                @auth
                    ...
                    <a href="{{ route('student.notifications') }}" class="flex items-center text-white hover:text-orange-400 transition-colors py-2">
                        <div class="relative">
                            ...
                            @if($unreadCount > 0)
                                <span id="notification-badge-mobile" class="absolute -top-1 right-1 flex h-2 w-2">
                                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                    <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500 border border-black/20"></span>
                                </span>
                            @endif
                        </div>
                        Notification
